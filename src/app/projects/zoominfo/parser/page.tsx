      ...
      <section className="pb-20">
        <div className="container max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-6xl md:text-8xl font-display font-black mb-8 gradient-text">Job Description Parser</h1>
            <p className="text-2xl text-light mb-12 max-w-4xl">
              AI-powered tool that helps recruiters parse and analyze job descriptions, improving efficiency by 40%.
            </p>
            <div className="card">
